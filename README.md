...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kfvzywm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kfvzywm.containers.anotherwebservice.com/
...
```
git clone git@github.com:pupupupu111/container-kfvzywm.git
cd container-kfvzywm
```
...
```
docker attach container-kfvzywm
```
